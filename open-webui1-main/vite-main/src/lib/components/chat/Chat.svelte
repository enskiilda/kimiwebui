<script lang="ts">
        ...
        let nvidiaController: AbortController | null = null;
        ...
        const sendMessageSocket = async (model, _messages, _history, responseMessageId, _chatId) => {
                ...
                if (isNvidiaModel(model.id)) {
                        const nvidiaMessages: NvidiaChatMessage[] = messages.map((msg) => ({
                        ...
                        nvidiaChatCompletionStream(
                                ...
                                async (content: string, done: boolean, error?: string) => {
                                        if (error) {
                                                toast.error(error);
                                        ...
                                        if (!done && !error && responseMessage.content === '' && content === '\n') {
                                                return;
                                        }
                                ...
                                <Pane defaultSize={50} minSize={30} class="h-full flex relative max-w-full flex-col">
                                        ...
                                        <div class="flex flex-col flex-auto z-10 w-full @container overflow-auto">
                                                {#if ($settings?.landingPageMode === 'chat' && !$selectedFolder) || createMessagesList(history, history.currentId).length > 0}
                                                        <div
                                                                class=" pb-2.5 flex flex-col justify-between flex-auto overflow-auto h-0 z-10 scrollbar-hidden"

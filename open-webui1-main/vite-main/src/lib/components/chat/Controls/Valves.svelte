<script lang="ts">
        ...
        import { getTools, getFunctions, getToolUserValvesById, getToolUserValvesSpecById, getFunctionUserValvesById, getFunctionUserValvesSpecById, updateToolUserValvesById, updateFunctionUserValvesById } from '$lib/localStorage';
